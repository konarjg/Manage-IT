...
public class AcceptInvite : PageModel
{
    public IActionResult OnGet(long userId, long projectId)
    {
        ...
        string subject1 = "Manage IT Notification: User accepted an invite to Your project";
        string body1 = $"Dear {manager.Login},<br/>{user.Login} has accepted the invite to Your project named {project.Name}!<br/>Happy Managing IT!";
        string subject2 = "Manage IT Notification: You succesfully joined a project!";
        string body2 = $"Dear {user.Login},<br/>You successfully accepted an invite to project named {project.Name} and can now collaborate on IT!<br/> Check out Your project panel!";
        string error;
